    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-purple-500/20">
                        {messages.map((msg) => (
                            <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                <div className={`max-w-[80%] rounded-2xl p-3 text-sm font-body ${msg.role === 'user'
            ...
            <button
                ...
                className="group relative flex h-14 w-14 p-0 shrink-0 items-center justify-center rounded-full bg-gold-gradient text-deep-purple shadow-[0_0_20px_rgba(252,211,77,0.4)] transition-all duration-300 hover:scale-105 overflow-hidden"
                aria-label={isOpen ? "Cerrar chat" : "Abrir chat con Aura"}
            >
